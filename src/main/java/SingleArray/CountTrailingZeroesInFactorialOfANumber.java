...
public class CountTrailingZeroesInFactorialOfANumber {
	...
	public int trailingZero(int number) {
		 ...
		 * Whenever value's like 25, 26....29 comes in, we need to count that extra 5[ for that we need for loop] that value 25, 125, 225,325 and so on.
		 * 
		 * For example if we consider 28, we get one extra 5 and number of 0s become 6.
		 * 
		 *  	Step1: 28/5  = 5				126/5  = 25
		 *  	Step2  28/25 = 1				126/25 =  5
		 *  			=========				126/125 = 1
		 *  		total      6             ==================
		 *  									Total     31
		 * 
		 * Handling this is simple, 
		 * first divide n by 5 and count all single 5s, 
		 * then divide by 25 to count extra 5s and so on. 
		 * 
