...
public class RottingOranges {
	 ...
	 * add indices pair for rotten orange into queue. 
	 * 
	 * int[][] direction = {{1, 0}, {0, 1}, {-1, 0}, {0, -1}}; define 4 direction array for 4 adjacent neighbours
	 * and time to count minutes needed. 
	 * 
	 * Loop over until queue not empty and
	 * freshCount > 0, Now we know have all the rotten orange for first-level into
	 * our queue we will check 4-direction oranges if it is fresh make it rotten and
	 * decrease freshCount by 1 every time when we found fresh orange otherwise just
	 * continue. 
	 * 
	 * Once loop break check if freshCount == 0 return time else -1 not
	 * possible.
	 */
